...
<svelte:head>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I download a Pinterest video?","acceptedAnswer":{"@type":"Answer","text":"Open the Pinterest pin, tap the share icon or copy the URL from your browser's address bar. Paste the link into SnapSave above and click download."}},{"@type":"Question","name":"Can I download Pinterest videos without an account?","acceptedAnswer":{"@type":"Answer","text":"Yes. SnapSave works with public Pinterest pins without any login. Just paste the public pin URL."}},{"@type":"Question","name":"Does SnapSave support pin.it short links?","acceptedAnswer":{"@type":"Answer","text":"Yes. Both pinterest.com links and pin.it short links are fully supported. Paste either format and SnapSave will handle the rest."}},{"@type":"Question","name":"What quality are downloaded Pinterest videos?","acceptedAnswer":{"@type":"Answer","text":"SnapSave downloads at the highest quality available from Pinterest's servers, typically HD where the original video was uploaded in high resolution."}},{"@type":"Question","name":"Why isn't my Pinterest link working?","acceptedAnswer":{"@type":"Answer","text":"Make sure the pin is publicly accessible and contains a video (not just a photo). Private boards and deleted pins cannot be downloaded."}}]}</script>
</svelte:head>
    ...
    <section class="lp-section lp-links">
        <div class="lp-inner">
            ...
            <div class="lp-link-grid">
                ...
                <a href="/blog/how-to-download-pinterest-videos-on-iphone" class="lp-link">How to Download Pinterest Videos →</a>
            </div>
        </div>
    </section>
</div>
